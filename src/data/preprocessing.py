...
import os
print("Python скрипт запущен из:", os.getcwd())
print("Путь к файлу:", os.path.abspath("data/raw/events.csv"))
print("Файл существует:", os.path.exists("data/raw/events.csv"))
...
#     user2idx = {int(u): i + 1 for i, u in enumerate(user_ids)}
#     item2idx = {int(i): j + 1 for j, i in enumerate(item_ids)}
